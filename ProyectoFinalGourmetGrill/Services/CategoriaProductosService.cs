...
{
    public class CategoriaProductosService : IServer<CategoriaProductos>
    {
        private readonly IDbContextFactory<ApplicationDbContext> _contextFactory;

        public CategoriaProductosService(IDbContextFactory<ApplicationDbContext> contextFactory) {
