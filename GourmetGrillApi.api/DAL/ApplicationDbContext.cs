...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public void ConfigureProductosModel(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Productos>().HasData(
             ...
             new Productos { Nombre = "Funghi Girl", Cantidad = 50, Precio = 500, ProductoId = 2, CategoriaId = 1, Disponible = true, Descripcion = "Pan de Papa, Doble Carne de 95g, Doble Queso Americano, Mermelada de Bacon y Crema de Hongos Trufada" },
             new Productos { Nombre = "La Formula", Cantidad = 50, Precio = 450, ProductoId = 3, CategoriaId = 1, Disponible = true, Descripcion = "Pan de Papa, Doble Carne de 95g, Doble Queso Americano, Pulled Pork y Coleslaw" },
