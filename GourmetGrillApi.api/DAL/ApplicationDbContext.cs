...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public void ConfigureProductosModel(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Productos>().HasData(
             ...
             new Productos { Nombre = "La Formula", Cantidad = 50, Precio = 450, ProductoId = 3, CategoriaId = 1, Disponible = true, Descripcion = "Pan de Papa, Doble Carne de 95g, Doble Queso Americano, Pulled Pork y Coleslaw", ImagenUrl = "https://stgourmetgrilldv001.blob.core.windows.net/gourmetweb/CheeseBurguer.jpg" },
